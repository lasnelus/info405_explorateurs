...
const enfantsAujourdhui = ref([
  ...
  { id_enfant: "enf004", nom: "NORRIS", prenom: "Lando", regime_special: "vegetarien", present: true },
  { id_enfant: "enf005", nom: "RUSSELL", prenom: "George", regime_special: "sans_gluten", present: true },
