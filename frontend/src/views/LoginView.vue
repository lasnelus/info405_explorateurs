    ...
    <div class="flex flex-col gap-6 w-full max-w-sm">
        ...
        <form @submit.prevent="handleLogin">
          <div class="mb-6">
            <input
              ...
              class="w-full px-4 py-3.5 rounded-lg font-semibold text-sm text-gray-800 uppercase placeholder:text-gray-500 focus:outline-none transition-all"
              :style="{
          ...
          <div class="mb-6 relative">
            ...
            <button
              type="button"
              class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 p-2 rounded"
          ...
          <div class="text-center mb-6">
            <a
              ...
              class="hover:underline text-sm transition-colors"
              :style="{ 'color': 'var(--color-primary)' }"
            >
              mot de passe oublié ?
            </a>
      ...
      <div class="bg-white rounded-2xl shadow-lg p-6">
        <div class="flex flex-col items-center gap-4">
          <p class="text-sm font-semibold tracking-wide" :style="{ 'color': 'var(--color-primary)' }">PAS DE COMPTE ?</p>
          <button
            @click="goToSignup"
